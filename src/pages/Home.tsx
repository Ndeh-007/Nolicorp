                        ...
                        <IonToolbar color={`dark`}>
                            <IonRow style={{ margin: 0, padding: 0 }}>
                                <IonCol style={{ margin: 0, padding: 0 }}>
                                    <img alt={``} style={{ height: `100%`, objectFit: `cover` }} src={local_images.ad1}></img>
                                </IonCol>
                                <IonCol size={`12`} sizeSm={`8`} sizeMd={`6`} className={`ion-align-self-center `}  >
                                    <section className="services ion-padding">
                                        <h2> We have an amazing Customer Service</h2>
                                        <p>
                                            At Nolicorp we focus on providing our customers with <b>REAL VALUE</b>. This can be seen in the <b>Quality of our Prints</b>
                                           , <b>Affordability</b>
                                            <b>Amazing Customer Service</b>
                                        </p>
                                        <p>
                                            <h5>Working with so many companies, brands and clients over the years we are proud to say we give the very best and we continue to improve</h5>
                                        </p>
                                    </section>
                                </IonCol>
                            </IonRow>
                        ...
                        <IonToolbar color={`light`}>
                            ...
                            <IonRow>
                                ...
                                <IonCol size={`12`} sizeSm={`11`} sizeMd={`10`} >
                                    <section className="services">
                                        ...
                                        <p>
                                            At Nolicorp we provide tons of services. few of our printing services include
                              </p>
                                        <p>
                                            <br />
                                            <br />
                                            ...
                                            <IonRow>
                                                {
                                                    services.map(serv => <IonCol size={`12`} sizeSm={`12`} sizeMd={`6`} sizeLg={`4`}>
                                                        <ServiceCard serv={serv} ></ServiceCard>
                                                    </IonCol>)

                                                }
                                                <IonCol className={`ion-align-self-center`} size={`12`} sizeSm={`12`} sizeMd={`6`} sizeLg={`4`}>
                                                    <IonCard className={`text-center`} mode={`ios`}>
                                                        <IonCardContent>
                                                            ...
                                                            <br />
                                                            <br />
                                                            <IonFabButton style={{ margin: `auto` }} color={`dark`}>
                            ...
                            <IonToolbar color={`dark`}>
                                <IonRow style={{ margin: 0, padding: 0 }}>
                                    ...
                                    <IonCol style={{ margin: 0, padding: 0 }}>
                                        <img style={{ height: `100%`, objectFit: `cover` }} src={local_images.ad1}></img>
                                    </IonCol>
                                </IonRow>
                            </IonToolbar>
                            <IonToolbar>
                                ...
                                <IonRow>
                                    ...
                                    <IonCol size={`12`} sizeSm={`11`} sizeMd={`10`} >
                                        <section className="team">
                                            ...
                                            <IonRow>
                                                {
                                                    NolicorpTeam.map(member => <IonCol size={`12`} sizeSm={`12`} sizeMd={`6`} sizeLg={`4`}>
                                                        <IonCard routerLink={`/team/${member.name}`} button className={`col-card`} mode={`ios`}>
                                                            <img style={{ height: `46vh`, width: `100%`, objectFit: `cover`, objectPosition: `0% 0%` }} src={member.photo}></img>
                                                            <IonCardContent className={`capitalize`}>
                                                                <IonCardTitle  >{member.name}</IonCardTitle>
                                                                <IonCardSubtitle>{member.position}</IonCardSubtitle>
                                        ...
                                        <IonToolbar className={`ion-padding`}>
                                            <h2>Geo Location</h2>
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15917.081249619378!2d9.2620325!3d4.1671777!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x8b384713e973866!2sNolicorp!5e0!3m2!1sen!2scm!4v1640881201642!5m2!1sen!2scm" width="100%" height="450" style={{ border: 0 }} loading="lazy"></iframe>
                                        </IonToolbar>
                                    </IonCol>
                                    <IonCol></IonCol>
                                </IonRow>
