...
import { IonButton, IonButtons, IonCard, IonCardContent, IonCardSubtitle, IonCardTitle, IonCol, IonContent, IonFabButton, IonFooter, IonGrid, IonIcon, IonImg, IonItem, IonLabel, IonMenuButton, IonNote, IonPage, IonPopover, IonRow, IonToolbar, useIonViewDidEnter } from '@ionic/react'
...
function TeamDetail() {
    ...
    useEffect(() => {
        ...
        if (params.name) {
            ...
            const persons = NolicorpTeam.filter(member => member.name == params.name)
                                ...
                                <IonRow ref={memberRef}>
                                    <IonCol>
                                        <div className={`text-center`}>
                                                <img alt={`banner image nolicorp`} style={{ maxHeight: `70vh` }} src={member?.photo} />
                                        </div>
                                    </IonCol>
                                    <IonCol size={`12`} sizeMd={`6`} className={`ion-align-self-center`}>
